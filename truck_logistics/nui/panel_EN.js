window.addEventListener('message', function (event) {
	...
	if (item.showmenu){
		...
		$('#new-contracts-1').append('New contracts each ' + config.cooldown + ' min');
		$('#new-contracts-2').empty();
		$('#new-contracts-2').append('New contracts each ' + config.cooldown + ' min');
